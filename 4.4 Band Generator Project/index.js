...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", { brandName: undefined });
});
...
app.post("/submit", (req, res) => {
  ...
  const brandAdj = adj[Math.floor(Math.random() * adj.length)];
  const brandNoun = noun[Math.floor(Math.random() * noun.length)];

  const nameOfbrand = brandAdj + " " + brandNoun;
  res.render("index.ejs", { brandName: nameOfbrand });
});
